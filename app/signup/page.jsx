...
<div className="flex flex-wrap w-full">
    <div className="flex flex-col w-full md:w-1/2">
        <div className="flex justify-center pt-12 md:justify-start md:pl-12 md:-mb-24">
            <a href="/" className="p-4 rounded-xl text-xl font-bold text-white bg-[#f6a78b]">
                Back to Home
            </a>
        </div>
        <div className="flex flex-col text-sky-800 justify-center px-8 pt-8 my-auto md:justify-start md:pt-0 md:px-24 lg:px-32">
            ...
            <form className="flex flex-col pt-3 md:pt-8">
                <div className="flex flex-col pt-4">
                    ...
                    <div className="flex flex-col pt-4 mb-12">
                        ...
                        <button type="submit" className="w-full px-4 py-2 text-base font-semibold text-center text-white transition duration-200 ease-in rounded-xl bg-[#f6a78b] shadow-md hover:text-black hover:[#f6a79a] focus:outline-none focus:ring-2">
            ...
            <div className="w-1/2 shadow-2xl">
                <img className="hidden object-cover w-full h-screen md:block" src="/images/catwindow.gif"/>
            </div>
        </div>
