  ...
  return(
    ...
    <div className="flex flex-col w-full md:w-1/2">
        <div className="flex justify-center pt-12  md:justify-start md:pl-12 md:-mb-24">
            <a href="/" className="p-4 rounded-xl text-xl  font-bold text-white bg-[#c94b58]">
                Back to Home
            </a>
        </div>
        <div className="flex flex-col text-red-800 justify-center px-8 pt-8 my-auto md:justify-start md:pt-0 md:px-24 lg:px-32">
            ...
            <div className="w-1/2 shadow-2xl">
                <img className="hidden object-cover w-full h-screen md:block" src="/images/doggif.gif"/>
            </div>
        </div>
    </>
  )
