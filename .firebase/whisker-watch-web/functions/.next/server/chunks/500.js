...
__webpack_require__.d(__webpack_exports__, {
  ZF: () => (/* reexport */ initializeApp)
});

// UNUSED EXPORTS: FirebaseError, SDK_VERSION, _DEFAULT_ENTRY_NAME, _addComponent, _addOrOverwriteComponent, _apps, _clearComponents, _components, _getProvider, _registerComponent, _removeServiceInstance, deleteApp, getApp, getApps, onLog, registerVersion, setLogLevel
...
var esm_index_esm2017 = __webpack_require__(7425);
...
var build = __webpack_require__(8647);
;// CONCATENATED MODULE: ./node_modules/firebase/node_modules/@firebase/app/dist/esm/index.esm2017.js
...
function getDbPromise() {
    if (!dbPromise) {
        dbPromise = (0,build/* openDB */.X3)(DB_NAME, DB_VERSION, {
...
var lib = __webpack_require__(8208);
...
const index_node_esm_version = "0.11.2";
...
function registerStorage() {
    _registerComponent(new index_esm2017/* Component */.wA(STORAGE_TYPE, factory, "PUBLIC" /* ComponentType.PUBLIC */).setMultipleInstances(true));
    registerVersion(index_node_esm_name, index_node_esm_version);
}
registerStorage();
